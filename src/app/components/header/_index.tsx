    ...
    <header>
      <div className="flex items-center justify-between h-full w-full ">
        <div className="container mx-auto max-w-screen-xl flex items-center justify-between px-4">
          <div className="header__profile flex items-center gap-2 w-2/3 lg:w-2/3">
            ...
            <div className="header__profile-info ">
              <div className="header__profile-name font-bold text-md">
                Bui Yen Linh
              </div>
              <div className="header__profile-title text-sm">
                Software Engineer
              </div>
            </div>
          </div>
